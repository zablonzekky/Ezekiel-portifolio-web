...
const Footer = () => {
  const socialLinks = [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/ezekiel-wekesa-162578241/',
      icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link to="/projects" className="block text-gray-300 hover:text-white transition-colors duration-200">Projects</Link>
              <Link to="/skills" className="block text-gray-300 hover:text-white transition-colors duration-200">Skills</Link>
